...
class SX127x:
    ...
    def FSK_Init(self,SyncWordComp = False,PreambDetect = False,CheckCRC = False,Continuous= False):
    ...
    def PrintFSKPktMode(self):
        ...
        print("-------------------------------------")
        print("PacketFormat: ",["Fixed length","Variable length"][RegPktMode1 >> 4 & 1])
